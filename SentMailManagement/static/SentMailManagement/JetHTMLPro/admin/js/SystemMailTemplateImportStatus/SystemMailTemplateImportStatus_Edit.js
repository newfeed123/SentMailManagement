...
var MPSSystemMailTemplateImportStatusSentMailManagementEditSystemMailTemplateImportStatus = function () {
    // Shared variables
    const form = document.getElementById('SystemMailTemplateImportStatusSentMailManagementEditId_form');
    ...
    var initEditSystemMailTemplateImportStatus = () => {
        ...
        if(obj_uuid != null && obj_uuid != undefined && obj_uuid != ""){
            ...
            obj.callAjax.then(function(data) {
                new SystemMailTemplateImportStatusSentMailManagement(data).tFillEditForm('SystemMailTemplateImportStatusSentMailManagementEditId_form');
            })
        }
        // Submit button handler
        const submitButton = form.querySelector('[systemmailtemplateimportstatussentmailmanagement-edit-action="submit"]');
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        obj.tUpdatePostApi('SystemMailTemplateImportStatusSentMailManagementEditId_form');
        ...
        const cancelButton = form.querySelector('[systemmailtemplateimportstatussentmailmanagement-edit-action="cancel"]');
