...
var MPSSystemMailSenderConfigSentMailManagementEditSystemMailSenderConfig_ckeditor_list = {}
"use strict";

// Class definition
var MPSSystemMailSenderConfigSentMailManagementEditSystemMailSenderConfig = function () {
    // Shared variables
    const element = document.getElementById('SystemMailSenderConfigSentMailManagementEditModalId');
    const form = element.querySelector('#SystemMailSenderConfigSentMailManagementEditModalId_form');
    ...
    const initCKEditor = () => {
        ...
        elements.forEach(element => {
            ...
            DecoupledEditor
                .create(ck_editor)
                .then(editor => {
                    MPSSystemMailSenderConfigSentMailManagementEditSystemMailSenderConfig_ckeditor_list[element] = editor;
    ...
    var initEditSystemMailSenderConfig = () => {
        ...
        const submitButton = element.querySelector('[systemmailsenderconfigsentmailmanagement-edit-modal-action="submit"]');
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        obj.tUpdatePostApi('SystemMailSenderConfigSentMailManagementEditModalId_form');
        ...
        const cancelButton = element.querySelector('[systemmailsenderconfigsentmailmanagement-edit-modal-action="cancel"]');
        ...
        const closeButton = element.querySelector('[systemmailsenderconfigsentmailmanagement-edit-modal-action="close"]');
...
KTUtil.onDOMContentLoaded(function () {
    MPSSystemMailSenderConfigSentMailManagementEditSystemMailSenderConfig.init();
});
