...
var MPSSystemMailMailSentMailManagementEditSystemMailMail_ckeditor_list = {}
"use strict";

// Class definition
var MPSSystemMailMailSentMailManagementEditSystemMailMail = function () {
    // Shared variables
    const element = document.getElementById('SystemMailMailSentMailManagementEditModalId');
    const form = element.querySelector('#SystemMailMailSentMailManagementEditModalId_form');
    ...
    const initCKEditor = () => {
        ...
        const elements = [
            '#contentSystemMailMailSentMailManagementEditModalInputId', 
        ];
        ...
        elements.forEach(element => {
            ...
            DecoupledEditor
                .create(ck_editor)
                .then(editor => {
                    MPSSystemMailMailSentMailManagementEditSystemMailMail_ckeditor_list[element] = editor;
    ...
    var initEditSystemMailMail = () => {
        ...
        const submitButton = element.querySelector('[systemmailmailsentmailmanagement-edit-modal-action="submit"]');
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        systemmailmailsentmailmanagement_is_continue_form=true;
                        obj.tUpdatePostApi('SystemMailMailSentMailManagementEditModalId_form');
        ...
        const cancelButton = element.querySelector('[systemmailmailsentmailmanagement-edit-modal-action="cancel"]');
        ...
        const closeButton = element.querySelector('[systemmailmailsentmailmanagement-edit-modal-action="close"]');
...
KTUtil.onDOMContentLoaded(function () {
    MPSSystemMailMailSentMailManagementEditSystemMailMail.init();
});
