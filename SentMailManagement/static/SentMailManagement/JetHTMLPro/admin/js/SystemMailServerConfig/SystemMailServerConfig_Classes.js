...
class SystemMailServerConfigSentMailManagement {
    ...
    tFillForm() {
        var self = this;
            ...
            try{
                var j_ele_active = $("#activeSystemMailServerConfigSentMailManagementInputId");
    ...
    tFillCreateForm(formId = null) {
            ...
            try{
                var j_ele_active = $("#activeSystemMailServerConfigSentMailManagementCreateInputId");
                    if (j_ele_active.length > 0){
    ...
    tFillEditForm(formId = null) {
        self = this
            ...
            try{
                var j_ele_active = $("#activeSystemMailServerConfigSentMailManagementEditInputId");
                    if (j_ele_active.length > 0){
    ...
    tFillEditModalForm(formId = null) {
        self = this
            ...
            try{
                var j_ele_active = $("#activeSystemMailServerConfigSentMailManagementEditModalInputId");
                    if (j_ele_active.length > 0){
    ...
    tFillDetailForm(formId = null) {
        self = this
            ...
            try{
                var j_ele_active = $("#activeSystemMailServerConfigSentMailManagementDetailInputId");
                    if (j_ele_active.length > 0){
    ...
    tFillDetailModalForm(formId = null) {
        self = this
            ...
            try{
                var j_ele_active = $("#activeSystemMailServerConfigSentMailManagementDetailModalInputId");
                    if (j_ele_active.length > 0){
    ...
    tDatatableAddRow(tableId = null, order = null) {
        ...
        if (table.length > 0) {
            ...
            for (var thId = 1; thId < tableHeaders.length; thId++) {
                ...
                if (this.hasOwnProperty(attr)) {
                    ...
                    if(attr=="active"){
                        ...
                        row_data[col_num] = (`
                        <div class="form-check form-switch">
                            <input class="form-check-input" id="${this["uuid"]}activeSystemMailServerConfigSentMailManagementSwitchListTablebtnId" name="`+ attr +`" data-uuid="` + this["uuid"] + `" type="checkbox"  `+value+` onclick="activeSystemMailServerConfigSentMailManagementEventChangeSwitcher(this)">
                            <label class="form-check-label" for="${this["uuid"]}activeSystemMailServerConfigSentMailManagementSwitchListTablebtnId"></label>
                        </div>
                                `);
            ...
            SystemMailServerConfigSentMailManagementdatatable.draw(false);
...
//########## [Event] active ChangeSwitcher ##############
function activeSystemMailServerConfigSentMailManagementEventChangeSwitcher($this){
        var status="";
        var name = "Hoạt động";
        var is_checked = false;
        if ($($this).is(":checked")) {
