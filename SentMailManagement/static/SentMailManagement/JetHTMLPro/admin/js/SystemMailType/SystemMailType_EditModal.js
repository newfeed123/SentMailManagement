...
var MPSSystemMailTypeSentMailManagementEditSystemMailType = function () {
    // Shared variables
    const element = document.getElementById('SystemMailTypeSentMailManagementEditModalId');
    const form = element.querySelector('#SystemMailTypeSentMailManagementEditModalId_form');
    ...
    var initEditSystemMailType = () => {
        ...
        const submitButton = element.querySelector('[systemmailtypesentmailmanagement-edit-modal-action="submit"]');
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        obj.tUpdatePostApi('SystemMailTypeSentMailManagementEditModalId_form');
        ...
        const cancelButton = element.querySelector('[systemmailtypesentmailmanagement-edit-modal-action="cancel"]');
        ...
        const closeButton = element.querySelector('[systemmailtypesentmailmanagement-edit-modal-action="close"]');
