...
var MPSSystemMailTemplateImportDataSentMailManagementEditSystemMailTemplateImportData = function () {
    // Shared variables
    const element = document.getElementById('SystemMailTemplateImportDataSentMailManagementEditModalId');
    const form = element.querySelector('#SystemMailTemplateImportDataSentMailManagementEditModalId_form');
    ...
    const initCKEditor = () => {
        ...
        const elements = [
            '#json_import_dataSystemMailTemplateImportDataSentMailManagementEditModalInputId','#json_check_validationSystemMailTemplateImportDataSentMailManagementEditModalInputId','#json_fail_dataSystemMailTemplateImportDataSentMailManagementEditModalInputId', 
        ];
    ...
    var initEditSystemMailTemplateImportData = () => {
        ...
        const submitButton = element.querySelector('[systemmailtemplateimportdatasentmailmanagement-edit-modal-action="submit"]');
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        obj.tUpdatePostApi('SystemMailTemplateImportDataSentMailManagementEditModalId_form');
        ...
        const cancelButton = element.querySelector('[systemmailtemplateimportdatasentmailmanagement-edit-modal-action="cancel"]');
