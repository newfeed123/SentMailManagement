                    ...
                    if (j_ele_target.length > 0){
                        ...
                        if(target_select_value == undefined || target_select_value == null || target_select_value.length == 0){
                            for(var i in self["target"]){
                                ...
                                j_ele_target.append(new Option(target_name + "(đã lưu)", target_value,true,true));
                            }
                ...
                setTimeout(()=>{
                    ...
                    if (j_ele_target.length > 0){
                        ...
                        for(var i in self["target"]){
                            ...
                            arr_value.push(self["target"][i]["uuid"]);
                            var target_value = self["target"][i]["uuid"];
                            var name_list_detail = `<a href="${org_app_prefix}/HRAccountManagement/HRAccount/detail/${target_value}/" class="text-gray-600 text-hover-primary" name="$field_name_system_use"><span class="badge badge-primary">${self["target"][i]["name"]} </span></a>`;
