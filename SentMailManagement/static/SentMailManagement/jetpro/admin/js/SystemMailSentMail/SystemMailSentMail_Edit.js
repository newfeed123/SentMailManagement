...
var MPSSystemMailSentMailSentMailManagementEditSystemMailSentMail = function () {
    // Shared variables
    const form = document.getElementById('SystemMailSentMailSentMailManagementEditId_form');
    
    // Init ck editor
    const initCKEditor = () => {
        // Define all elements for ck editor
        const elements = [
            '#contentSystemMailSentMailSentMailManagementEditInputId', 
        ];
    ...
    var initEditSystemMailSentMail = () => {
        ...
        if(obj_uuid != null && obj_uuid != undefined && obj_uuid != ""){
            ...
            obj.callAjax.then(function(data) {
                new SystemMailSentMailSentMailManagement(data).tFillEditForm('SystemMailSentMailSentMailManagementEditId_form');
            })
        }
        // Submit button handler
        const submitButton = form.querySelector('[systemmailsentmailsentmailmanagement-edit-action="submit"]');
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        obj.tUpdatePostApi('SystemMailSentMailSentMailManagementEditId_form');
        ...
        const cancelButton = form.querySelector('[systemmailsentmailsentmailmanagement-edit-action="cancel"]');
