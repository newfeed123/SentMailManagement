...
var MPSSystemMailSentMailSentMailManagementDetailSystemMailSentMail_ckeditor_list = {}
"use strict";

// Class definition
var MPSSystemMailSentMailSentMailManagementDetailSystemMailSentMail = function () {
    // Shared variables
    const element = document.getElementById('SystemMailSentMailSentMailManagementDetailModalId');
    const form = element.querySelector('#SystemMailSentMailSentMailManagementDetailModalId_form');
    ...
    const initCKEditor = () => {
        ...
        elements.forEach(element => {
            ...
            DecoupledEditor
                .create(ck_editor)
                .then(editor => {
                    MPSSystemMailSentMailSentMailManagementDetailSystemMailSentMail_ckeditor_list[element] = editor;
    ...
    var initEditSystemMailSentMail = () => {
        ...
        const cancelButton = element.querySelector('[systemmailsentmailsentmailmanagement-detail-modal-action="cancel"]');
        ...
        const closeButton = element.querySelector('[systemmailsentmailsentmailmanagement-detail-modal-action="close"]');
...
KTUtil.onDOMContentLoaded(function () {
    MPSSystemMailSentMailSentMailManagementDetailSystemMailSentMail.init();
});
