...
var MPSSystemMailSentMailSentMailManagementDetailSystemMailSentMail = function () {
    // Shared variables
    const form = document.getElementById('SystemMailSentMailSentMailManagementDetailId_form');

    // Init add schedule modal
    var initDetailSystemMailSentMail = () => {
        ...
        if(obj_uuid != null && obj_uuid != undefined && obj_uuid != ""){
            ...
            obj.callAjax.then(function(data) {
                new SystemMailSentMailSentMailManagement(data).tFillDetailForm('SystemMailSentMailSentMailManagementDetailId_form');
            })
        }
        // Cancel button handler
        const cancelButton = form.querySelector('[systemmailsentmailsentmailmanagement-detail-action="cancel"]');
