...
var MPSSystemMailSentMailSentMailManagementAddSystemMailSentMail = function () {
    // Shared variables
    const element = document.getElementById('SystemMailSentMailSentMailManagementCreateModalId');
    const form = element.querySelector('#SystemMailSentMailSentMailManagementCreateModalId_form');
    ...
    const initCKEditor = () => {
        ...
        const elements = [
            '#contentSystemMailSentMailSentMailManagementCreateModalInputId', 
        ];
    ...
    var initAddSystemMailSentMail = () => {
        ...
        const submitButton = element.querySelector('[systemmailsentmailsentmailmanagement-add-modal-action="submit"]');
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        obj.tCreateNewPostFormApi('SystemMailSentMailSentMailManagementCreateModalId_form');
...
//
        ...
        const cancelButton = element.querySelector('[systemmailsentmailsentmailmanagement-add-modal-action="cancel"]');
        ...
        const closeButton = element.querySelector('[systemmailsentmailsentmailmanagement-add-modal-action="close"]');
