...
var MPSSystemMailMailSentMailManagementDetailSystemMailMail_ckeditor_list = {}
"use strict";

// Class definition
var MPSSystemMailMailSentMailManagementDetailSystemMailMail = function () {
    // Shared variables
    const element = document.getElementById('SystemMailMailSentMailManagementDetailModalId');
    const form = element.querySelector('#SystemMailMailSentMailManagementDetailModalId_form');
    ...
    const initCKEditor = () => {
        ...
        elements.forEach(element => {
            ...
            DecoupledEditor
                .create(ck_editor)
                .then(editor => {
                    MPSSystemMailMailSentMailManagementDetailSystemMailMail_ckeditor_list[element] = editor;
    ...
    var initEditSystemMailMail = () => {
        ...
        const cancelButton = element.querySelector('[systemmailmailsentmailmanagement-detail-modal-action="cancel"]');
        ...
        const closeButton = element.querySelector('[systemmailmailsentmailmanagement-detail-modal-action="close"]');
