...
var MPSSystemMailTemplateImportStatusSentMailManagementDetailSystemMailTemplateImportStatus_ckeditor_list = {}
"use strict";

// Class definition
var MPSSystemMailTemplateImportStatusSentMailManagementDetailSystemMailTemplateImportStatus = function () {
    // Shared variables
    const element = document.getElementById('SystemMailTemplateImportStatusSentMailManagementDetailModalId');
    const form = element.querySelector('#SystemMailTemplateImportStatusSentMailManagementDetailModalId_form');
    ...
    const initCKEditor = () => {
        ...
        elements.forEach(element => {
            ...
            DecoupledEditor
                .create(ck_editor)
                .then(editor => {
                    MPSSystemMailTemplateImportStatusSentMailManagementDetailSystemMailTemplateImportStatus_ckeditor_list[element] = editor;
    ...
    var initEditSystemMailTemplateImportStatus = () => {
        ...
        const cancelButton = element.querySelector('[systemmailtemplateimportstatussentmailmanagement-detail-modal-action="cancel"]');
        ...
        const closeButton = element.querySelector('[systemmailtemplateimportstatussentmailmanagement-detail-modal-action="close"]');
...
KTUtil.onDOMContentLoaded(function () {
    MPSSystemMailTemplateImportStatusSentMailManagementDetailSystemMailTemplateImportStatus.init();
});
