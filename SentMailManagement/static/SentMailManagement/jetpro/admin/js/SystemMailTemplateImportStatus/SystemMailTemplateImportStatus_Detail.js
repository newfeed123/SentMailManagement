...
var MPSSystemMailTemplateImportStatusSentMailManagementDetailSystemMailTemplateImportStatus = function () {
    // Shared variables
    const form = document.getElementById('SystemMailTemplateImportStatusSentMailManagementDetailId_form');

    // Init add schedule modal
    var initDetailSystemMailTemplateImportStatus = () => {
        ...
        if(obj_uuid != null && obj_uuid != undefined && obj_uuid != ""){
            ...
            obj.callAjax.then(function(data) {
                new SystemMailTemplateImportStatusSentMailManagement(data).tFillDetailForm('SystemMailTemplateImportStatusSentMailManagementDetailId_form');
            })
        }
        // Cancel button handler
        const cancelButton = form.querySelector('[systemmailtemplateimportstatussentmailmanagement-detail-action="cancel"]');
    ...
    return {
        // Public functions
        init: function () {
            initDetailSystemMailTemplateImportStatus();
        }
    };
}();
