...
var MPSSystemMailTemplateImportStatusSentMailManagementAddSystemMailTemplateImportStatus = function () {
    // Shared variables
    const element = document.getElementById('SystemMailTemplateImportStatusSentMailManagementCreateModalId');
    const form = element.querySelector('#SystemMailTemplateImportStatusSentMailManagementCreateModalId_form');
    ...
    var initAddSystemMailTemplateImportStatus = () => {
        ...
        const submitButton = element.querySelector('[systemmailtemplateimportstatussentmailmanagement-add-modal-action="submit"]');
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        obj.tCreateNewPostFormApi('SystemMailTemplateImportStatusSentMailManagementCreateModalId_form');
...
//
        ...
        const cancelButton = element.querySelector('[systemmailtemplateimportstatussentmailmanagement-add-modal-action="cancel"]');
        ...
        const closeButton = element.querySelector('[systemmailtemplateimportstatussentmailmanagement-add-modal-action="close"]');
