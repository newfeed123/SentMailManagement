...
var MPSSystemMailSenderConfigSentMailManagementEditSystemMailSenderConfig = function () {
    // Shared variables
    const form = document.getElementById('SystemMailSenderConfigSentMailManagementEditId_form');
    ...
    var initEditSystemMailSenderConfig = () => {
        ...
        if(obj_uuid != null && obj_uuid != undefined && obj_uuid != ""){
            ...
            obj.callAjax.then(function(data) {
                new SystemMailSenderConfigSentMailManagement(data).tFillEditForm('SystemMailSenderConfigSentMailManagementEditId_form');
            })
        }
        // Submit button handler
        const submitButton = form.querySelector('[systemmailsenderconfigsentmailmanagement-edit-action="submit"]');
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        obj.tUpdatePostApi('SystemMailSenderConfigSentMailManagementEditId_form');
        ...
        const cancelButton = form.querySelector('[systemmailsenderconfigsentmailmanagement-edit-action="cancel"]');
