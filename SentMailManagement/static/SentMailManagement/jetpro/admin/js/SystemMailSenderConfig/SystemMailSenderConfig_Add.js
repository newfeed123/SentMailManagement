...
"use strict";
var MPSSystemMailSenderConfigSentMailManagementAddSystemMailSenderConfig_ckeditor_list = {}

// Class definition
var MPSSystemMailSenderConfigSentMailManagementAddSystemMailSenderConfig = function () {
    // Shared variables
    const form = document.getElementById('SystemMailSenderConfigSentMailManagementCreateId_form');
    ...
    const initCKEditor = () => {
        ...
        elements.forEach(element => {
            ...
            DecoupledEditor
                .create(ck_editor)
                .then(editor => {
                    MPSSystemMailSenderConfigSentMailManagementAddSystemMailSenderConfig_ckeditor_list[element] = editor;
    ...
    var initAddSystemMailSenderConfig = () => {
        ...
        const submitButton = form.querySelector('[systemmailsenderconfigsentmailmanagement-add-action="submit"]');
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        systemmailsenderconfigsentmailmanagement_is_continue_form=true;
                        obj.tCreateNewPostFormApi('SystemMailSenderConfigSentMailManagementCreateId_form');
                            ...
                            if (data.uuid != undefined && data.uuid != null && data.uuid != ""){
                                ...
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        ...
                                        $(location).prop('href', `${org_app_prefixId}/SentMailManagement/SystemMailSenderConfig/detail/${data.uuid}/`);
                                    }
                                });
                            }
...
//
        ...
        const cancelButton = form.querySelector('[systemmailsenderconfigsentmailmanagement-add-action="cancel"]');
        cancelButton.addEventListener('click', e => {
            e.preventDefault();

            Swal.fire({
                html: "Bạn có chắc muốn hủy quá trình thêm mới <b>Cấu hình email gửi đi</b> này?",
                icon: "warning",
...
KTUtil.onDOMContentLoaded(function () {
    MPSSystemMailSenderConfigSentMailManagementAddSystemMailSenderConfig.init();
});
