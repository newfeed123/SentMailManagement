...
var MPSSystemMailSenderConfigSentMailManagementAddSystemMailSenderConfig = function () {
    // Shared variables
    const element = document.getElementById('SystemMailSenderConfigSentMailManagementCreateModalId');
    const form = element.querySelector('#SystemMailSenderConfigSentMailManagementCreateModalId_form');
    ...
    var initAddSystemMailSenderConfig = () => {
        ...
        const submitButton = element.querySelector('[systemmailsenderconfigsentmailmanagement-add-modal-action="submit"]');
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        obj.tCreateNewPostFormApi('SystemMailSenderConfigSentMailManagementCreateModalId_form');
...
//
        ...
        const cancelButton = element.querySelector('[systemmailsenderconfigsentmailmanagement-add-modal-action="cancel"]');
        ...
        const closeButton = element.querySelector('[systemmailsenderconfigsentmailmanagement-add-modal-action="close"]');
