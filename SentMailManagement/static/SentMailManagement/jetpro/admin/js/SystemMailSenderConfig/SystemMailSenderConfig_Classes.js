...
class SystemMailSenderConfigSentMailManagement {
    ...
    constructor(data = null) {
        if (data != null) {
            ...
            if (data.hasOwnProperty('number_sent')) {
                this.number_sent = data.number_sent;
            }
    ...
    tGetFormData(formId = null) {
        ...
        if (formEle.length > 0) {
            ...
            var chEle_number_sent = formEle.find("#number_sentSystemMailSenderConfigSentMailManagementInputId");
            if (chEle_number_sent.length > 0) {
                this.number_sent = chEle_number_sent.val();
            } 
            ...
            var chEle_active = formEle.find("#activeSystemMailSenderConfigSentMailManagementInputId");
                ...
                var j_ele_email_server = $("#email_serverSystemMailSenderConfigSentMailManagementInputId");
                    if (j_ele_email_server.length > 0){
                        ...
                        if(email_server_select_value == undefined || email_server_select_value == null){
                            ...
                            j_ele_email_server.append(new Option(email_server_name, email_server_value,true,true));
                        }
                    }
            }
            catch(err) {
    ...
    tFillEditModalForm(formId = null) {
        self = this
            ...
            try{
                var j_ele_number_sent = $("#number_sentSystemMailSenderConfigSentMailManagementEditModalInputId");
                if (j_ele_number_sent.length > 0){
                    j_ele_number_sent.attr("allow_tracker_change","false");
                    if (j_ele_number_sent.attr('name') != 'uuid'){
                        j_ele_number_sent.val(self.number_sent).change();
                        j_ele_number_sent.attr("allow_tracker_change","true");
                        
                    }
                }
                else{
                    // j_ele_number_sent.val(null);
                }
            }
            catch(err) {
                console.log('err = ', err);
            ...
            try{
                var j_ele_active = $("#activeSystemMailSenderConfigSentMailManagementEditModalInputId");
                    if (j_ele_active.length > 0){
                    
                        if(self.active == undefined){
                            j_ele_active.prop('checked',false).change();
                        }
                        else {
            ...
            try{
                var j_ele_email_server = $("#email_serverSystemMailSenderConfigSentMailManagementDetailInputId");
                    if (j_ele_email_server.length > 0){
                        ...
                        var email_server_value = self["email_server"]["uuid"];
                        var email_server_name = `<a href="${org_app_prefix}/SentMailManagement/SystemMailServerConfig/detail/${email_server_value}/" class="text-gray-600 text-hover-primary me-2">${self["email_server"]["name"]}</a>`
    ...
    tFillDetailModalForm(formId = null) {
        self = this
            ...
            try{
                var j_ele_number_sent = $("#number_sentSystemMailSenderConfigSentMailManagementDetailModalInputId");
                if (j_ele_number_sent.length > 0){
                    if (j_ele_number_sent.attr('name') != 'uuid'){
                        j_ele_number_sent.html(self.number_sent).change();
                    }
                }
                else{
                    // j_ele_friendly_code.html(null);
            ...
            try{
                var j_ele_active = $("#activeSystemMailSenderConfigSentMailManagementDetailModalInputId");
                    if (j_ele_active.length > 0){
                ...
                if (this.hasOwnProperty(attr)) {
                    ...
                    if(attr=="active"){
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" id="${this["uuid"]}activeSystemMailSenderConfigSentMailManagementSwitchListTablebtnId" name="`+ attr +`" data-uuid="` + this["uuid"] + `" type="checkbox"  `+value+` onclick="activeSystemMailSenderConfigSentMailManagementEventChangeSwitcher(this)">
                            <label class="form-check-label" for="${this["uuid"]}activeSystemMailSenderConfigSentMailManagementSwitchListTablebtnId"></label>
                        </div>
                                `);
                    ...
                    //     row_data[col_num] = (`
                    //     <div class="form-check form-switch">
                    //         <input class="form-check-input" id="${this["uuid"]}is_defaultSystemMailSenderConfigSentMailManagementSwitchListTablebtnId" name="`+ attr +`" data-uuid="` + this["uuid"] + `" type="checkbox"  `+value+` onclick="is_defaultSystemMailSenderConfigSentMailManagementEventChangeSwitcher(this)">
                    //         <label class="form-check-label" for="${this["uuid"]}is_defaultSystemMailSenderConfigSentMailManagementSwitchListTablebtnId"></label>
                    //     </div>
                    //             `);
...
function activeSystemMailSenderConfigSentMailManagementEventChangeSwitcher($this){
    var status="";
    var name = "Active";
...
Swal.fire({
    ...
    if (result.value) {
        ...
        Swal.fire({
            ...
            LoadSystemMailSenderConfigSentMailManagementTableDataList()
            SystemMailSenderConfigSentMailManagementdatatable.draw()
        })
    }
});
