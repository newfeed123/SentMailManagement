...
var MPSSystemMailTypeSentMailManagementAddSystemMailType = function () {
    // Shared variables
    const form = document.getElementById('SystemMailTypeSentMailManagementCreateId_form');
    ...
    var initAddSystemMailType = () => {
        ...
        const submitButton = form.querySelector('[systemmailtypesentmailmanagement-add-action="submit"]');
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        obj.tCreateNewPostFormApi('SystemMailTypeSentMailManagementCreateId_form');
                            ...
                            if (data.uuid != undefined && data.uuid != null && data.uuid != ""){
                                ...
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        ...
                                        $(location).prop('href', `${org_app_prefixId}/SentMailManagement/SystemMailType/detail/${data.uuid}/`);
                                    }
                                });
                            }
...
//
        ...
        const cancelButton = form.querySelector('[systemmailtypesentmailmanagement-add-action="cancel"]');
        cancelButton.addEventListener('click', e => {
            e.preventDefault();

            Swal.fire({
                html: "Bạn có chắc muốn hủy quá trình thêm mới <b>Loại email</b> này?",
                icon: "warning",
