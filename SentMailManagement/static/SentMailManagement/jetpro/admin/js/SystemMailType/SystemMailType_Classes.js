...
class SystemMailTypeSentMailManagement {
    ...
    tDatatableAddRow(tableId = null, order = null) {
        ...
        if (table.length > 0) {
            ...
            // SystemMailTypeSentMailManagementdatatable.row.addByPos(row_data, 1, this["uuid"]);
            // SystemMailTypeSentMailManagementdatatable.column($('th[attr-name="created_at"]').index()).visible(false);
        ...
        if (table.length > 0) {
            ...
            for (var thId = 1; thId < tableHeaders.length; thId++) {
                ...
                if (this.hasOwnProperty(attr)) {
                    ...
                    if(attr=="created_at"){
                        if(this[attr] != undefined && this[attr] !== "None"){       
                            html +=`<td class="text-wrap text-center d-none" data-order='`+this[attr]+`'><a>` + strftime(this[attr],"DD/MM/YYYY HH:mm:ss") + `</a></td>`;
                        }
                        else{
                            html +=`<td class="text-wrap text-center d-none" data-order='`+this[attr]+`'><a></a></td>`;
