...
var MPSSystemMailTypeSentMailManagementDetailSystemMailType_ckeditor_list = {}
"use strict";

// Class definition
var MPSSystemMailTypeSentMailManagementDetailSystemMailType = function () {
    // Shared variables
    const element = document.getElementById('SystemMailTypeSentMailManagementDetailModalId');
    const form = element.querySelector('#SystemMailTypeSentMailManagementDetailModalId_form');
    ...
    const initCKEditor = () => {
        ...
        elements.forEach(element => {
            ...
            DecoupledEditor
                .create(ck_editor)
                .then(editor => {
                    MPSSystemMailTypeSentMailManagementDetailSystemMailType_ckeditor_list[element] = editor;
    ...
    var initEditSystemMailType = () => {
        ...
        const cancelButton = element.querySelector('[systemmailtypesentmailmanagement-detail-modal-action="cancel"]');
        ...
        const closeButton = element.querySelector('[systemmailtypesentmailmanagement-detail-modal-action="close"]');
