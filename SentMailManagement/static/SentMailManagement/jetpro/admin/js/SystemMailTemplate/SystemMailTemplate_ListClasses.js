...
function LoadSystemMailTemplateSentMailManagementList() {
    ...
    if ($(".sentmailmanagement-systemmailtemplate-select").length > 0) {
        ...
        obj.callAjax.then(function(data) {
            ...
            $(".sentmailmanagement-systemmailtemplate-select option").each(function() {
            ...
            if (data.hasOwnProperty('results')) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    if (listObjValue.includes(x.uuid)) {
                        ...
                        var select = $(".sentmailmanagement-systemmailtemplate-select");
                    ...
                    $(newOption).attr("content_email_template", x.content);

                    $(".sentmailmanagement-systemmailtemplate-select").append(newOption).trigger('change');
                }
