...
var MPSSystemMailTemplateSentMailManagementEditSystemMailTemplate_ckeditor_list = {}
"use strict";

// Class definition
var MPSSystemMailTemplateSentMailManagementEditSystemMailTemplate = function () {
    // Shared variables
    const element = document.getElementById('SystemMailTemplateSentMailManagementEditModalId');
    const form = element.querySelector('#SystemMailTemplateSentMailManagementEditModalId_form');
    ...
    const initCKEditor = () => {
        ...
        const elements = [
            '#contentSystemMailTemplateSentMailManagementEditModalInputId', 
        ];
        ...
        elements.forEach(element => {
            ...
            DecoupledEditor
                .create(ck_editor)
                .then(editor => {
                    MPSSystemMailTemplateSentMailManagementEditSystemMailTemplate_ckeditor_list[element] = editor;
    ...
    var initEditSystemMailTemplate = () => {
        ...
        const submitButton = element.querySelector('[systemmailtemplatesentmailmanagement-edit-modal-action="submit"]');
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        obj.tUpdatePostApi('SystemMailTemplateSentMailManagementEditModalId_form');
        ...
        const cancelButton = element.querySelector('[systemmailtemplatesentmailmanagement-edit-modal-action="cancel"]');
        ...
        const closeButton = element.querySelector('[systemmailtemplatesentmailmanagement-edit-modal-action="close"]');
...
KTUtil.onDOMContentLoaded(function () {
    MPSSystemMailTemplateSentMailManagementEditSystemMailTemplate.init();
});
