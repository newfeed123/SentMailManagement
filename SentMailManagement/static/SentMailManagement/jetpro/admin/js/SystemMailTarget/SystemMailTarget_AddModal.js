...
var MPSSystemMailTargetSentMailManagementAddSystemMailTarget_ckeditor_list = {}
"use strict";

// Class definition
var MPSSystemMailTargetSentMailManagementAddSystemMailTarget = function () {
    // Shared variables
    const element = document.getElementById('SystemMailTargetSentMailManagementCreateModalId');
    const form = element.querySelector('#SystemMailTargetSentMailManagementCreateModalId_form');
    ...
    const initCKEditor = () => {
        ...
        const elements = [
            '#contentSystemMailTargetSentMailManagementCreateModalInputId', 
        ];
        ...
        elements.forEach(element => {
            ...
            DecoupledEditor
                .create(ck_editor)
                .then(editor => {
                    MPSSystemMailTargetSentMailManagementAddSystemMailTarget_ckeditor_list[element] = editor;
    ...
    var initAddSystemMailTarget = () => {
        ...
        var validator = FormValidation.formValidation(
            ...
            'target': {
                validators: {
                    notEmpty: {
                        message: 'Người nhận không được trống'
        ...
        const submitButton = element.querySelector('[systemmailtargetsentmailmanagement-add-modal-action="submit"]');
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        obj.tCreateNewPostFormApi('SystemMailTargetSentMailManagementCreateModalId_form');
...
//
        ...
        const cancelButton = element.querySelector('[systemmailtargetsentmailmanagement-add-modal-action="cancel"]');
        ...
        const closeButton = element.querySelector('[systemmailtargetsentmailmanagement-add-modal-action="close"]');
...
KTUtil.onDOMContentLoaded(function () {
    MPSSystemMailTargetSentMailManagementAddSystemMailTarget.init();
});

function ChangeEmailTemplateSelect_AddModal(){
    $("#email_templateSystemMailTargetSentMailManagementCreateModalInputId").on("change", function() {
        // alert("ok add")
        var selectedValueEmailTemplate = $("#email_templateSystemMailTargetSentMailManagementCreateModalInputId").val();

        var contentTemplateMail = $(`[value="${selectedValueEmailTemplate}"]`).attr('content_email_template')

        // console.log("huy---------->contentTemplateMail---AddModal", contentTemplateMail)
        // var newDiv = $('<div>');
        ...
        var iframeContent = $('#displaySystemMailTargetSentMailManagementCreateModalInputId_textareaId')[0].contentDocument;
        iframeContent.open();
...
$(document).ready(function(){
    ChangeEmailTemplateSelect_AddModal()
    // alert("ok add")
})