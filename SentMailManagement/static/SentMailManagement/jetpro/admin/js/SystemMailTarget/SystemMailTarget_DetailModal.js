...
var MPSSystemMailTargetSentMailManagementDetailSystemMailTarget_ckeditor_list = {}
"use strict";

// Class definition
var MPSSystemMailTargetSentMailManagementDetailSystemMailTarget = function () {
    // Shared variables
    const element = document.getElementById('SystemMailTargetSentMailManagementDetailModalId');
    const form = element.querySelector('#SystemMailTargetSentMailManagementDetailModalId_form');
    ...
    const initCKEditor = () => {
        ...
        elements.forEach(element => {
            ...
            DecoupledEditor
                .create(ck_editor)
                .then(editor => {
                    MPSSystemMailTargetSentMailManagementDetailSystemMailTarget_ckeditor_list[element] = editor;
    ...
    var initEditSystemMailTarget = () => {
        ...
        const cancelButton = element.querySelector('[systemmailtargetsentmailmanagement-detail-modal-action="cancel"]');
        ...
        const closeButton = element.querySelector('[systemmailtargetsentmailmanagement-detail-modal-action="close"]');
