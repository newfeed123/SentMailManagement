...
var MPSSystemMailTargetSentMailManagementEditSystemMailTarget = function () {
    // Shared variables
    const form = document.getElementById('SystemMailTargetSentMailManagementEditId_form');
    
    // Init ck editor
    const initCKEditor = () => {
        // Define all elements for ck editor
        const elements = [
            '#contentSystemMailTargetSentMailManagementEditInputId', 
        ];
    ...
    var initEditSystemMailTarget = () => {
        ...
        if(obj_uuid != null && obj_uuid != undefined && obj_uuid != ""){
            ...
            obj.callAjax.then(function(data) {
                new SystemMailTargetSentMailManagement(data).tFillEditForm('SystemMailTargetSentMailManagementEditId_form');
            })
        }
        // Submit button handler
        const submitButton = form.querySelector('[systemmailtargetsentmailmanagement-edit-action="submit"]');
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        obj.tUpdatePostApi('SystemMailTargetSentMailManagementEditId_form');
        ...
        const cancelButton = form.querySelector('[systemmailtargetsentmailmanagement-edit-action="cancel"]');
