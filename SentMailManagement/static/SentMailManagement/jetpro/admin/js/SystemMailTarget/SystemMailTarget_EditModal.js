...
var MPSSystemMailTargetSentMailManagementEditSystemMailTarget_ckeditor_list = {}
"use strict";

// Class definition
var MPSSystemMailTargetSentMailManagementEditSystemMailTarget = function () {
    // Shared variables
    const element = document.getElementById('SystemMailTargetSentMailManagementEditModalId');
    const form = element.querySelector('#SystemMailTargetSentMailManagementEditModalId_form');
    ...
    const initCKEditor = () => {
        ...
        const elements = [
            '#contentSystemMailTargetSentMailManagementEditModalInputId', 
        ];
        ...
        elements.forEach(element => {
            ...
            DecoupledEditor
                .create(ck_editor)
                .then(editor => {
                    MPSSystemMailTargetSentMailManagementEditSystemMailTarget_ckeditor_list[element] = editor;
    ...
    var initEditSystemMailTarget = () => {
        ...
        const submitButton = element.querySelector('[systemmailtargetsentmailmanagement-edit-modal-action="submit"]');
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        systemmailtargetsentmailmanagement_is_continue_form=true;
                        obj.tUpdatePostApi('SystemMailTargetSentMailManagementEditModalId_form');
        ...
        const cancelButton = element.querySelector('[systemmailtargetsentmailmanagement-edit-modal-action="cancel"]');
        ...
        const closeButton = element.querySelector('[systemmailtargetsentmailmanagement-edit-modal-action="close"]');
...
KTUtil.onDOMContentLoaded(function () {
    MPSSystemMailTargetSentMailManagementEditSystemMailTarget.init();
});


function ChangeEmailTemplateSelect_EditModal(){
    $("#email_templateSystemMailTargetSentMailManagementEditModalInputId").on("change", function() {
        // alert("ok edit")

        var selectedValueEmailTemplate = $("#email_templateSystemMailTargetSentMailManagementEditModalInputId").val();

        var contentTemplateMail = $(`[value="${selectedValueEmailTemplate}"]`).attr('content_email_template')

        // console.log("huy---------->contentTemplateMail123", contentTemplateMail)
        var newDiv = $('<div>');
...
$(document).ready(function(){
    ChangeEmailTemplateSelect_EditModal()
})
