...
// Danh sach hraccount theo tổ chức cho form thêm mới cá nhân/nhóm nhận mail
const SYSTEMMAILTARGETSENTMAILMANAGEMENT_HRAccount_by_Organization =  SERVER + "/SentMailManagement/SystemMailTarget/HRAccount_by_Organization/";
//////////////////////////////###################################---TABLE DATABASE---##################################////////////////////////////////////////////
...
// Thêm mới bản ghi từ giao diện Compose Email
const SYSTEMMAILMAILSENTMAILMANAGEMENT_CREATE_URL_COMPOSE_EMAIL = SERVER + "/api/v1/sentmailmanagement/systemmailmail/compose-email/create/";
