                        ...
                        if(link != "#")
                        {
                            ...
                            `<!--begin::Item-->
                                <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                    <!--begin::Icon-->
                                    <img alt="" class="w-30px me-3" src="/static/jetpro/assets/media/svg/files/${type_file}.svg" />
                                    <!--end::Icon-->
                                    <!--begin::Info-->
                                    <div class="ms-1 fw-semibold">
                                        <!--begin::Desc-->
                                        <a href="${link}" class="fs-6 text-hover-primary fw-bold d-inline-block text-truncate mw-300px" title="${filename}">${filename}</a>
                                        <!--end::Desc-->
                                        <!--begin::Number-->
            ...
            try{
                var j_ele_import_status = $("#import_statusSystemMailTemplateImportDataSentMailManagementDetailInputId");
                    if (j_ele_import_status.length > 0){
                        ...
                        var import_status_value = self["import_status"]["uuid"];
                        var import_status_name = `<a href="${org_app_prefix}/SentMailManagement/SystemMailTemplateImportStatus/detail/${import_status_value}/" class="text-gray-600 text-hover-primary me-2">${self["import_status"]["name"]}</a>`
