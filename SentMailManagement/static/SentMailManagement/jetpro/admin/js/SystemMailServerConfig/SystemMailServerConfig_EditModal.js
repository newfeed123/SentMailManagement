...
var MPSSystemMailServerConfigSentMailManagementEditSystemMailServerConfig = function () {
    // Shared variables
    const element = document.getElementById('SystemMailServerConfigSentMailManagementEditModalId');
    const form = element.querySelector('#SystemMailServerConfigSentMailManagementEditModalId_form');
    ...
    var initEditSystemMailServerConfig = () => {
        ...
        const submitButton = element.querySelector('[systemmailserverconfigsentmailmanagement-edit-modal-action="submit"]');
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        obj.tUpdatePostApi('SystemMailServerConfigSentMailManagementEditModalId_form');
        ...
        const cancelButton = element.querySelector('[systemmailserverconfigsentmailmanagement-edit-modal-action="cancel"]');
        ...
        const closeButton = element.querySelector('[systemmailserverconfigsentmailmanagement-edit-modal-action="close"]');
