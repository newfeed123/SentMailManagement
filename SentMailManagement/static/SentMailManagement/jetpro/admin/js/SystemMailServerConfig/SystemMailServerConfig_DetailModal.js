...
var MPSSystemMailServerConfigSentMailManagementDetailSystemMailServerConfig_ckeditor_list = {}
"use strict";

// Class definition
var MPSSystemMailServerConfigSentMailManagementDetailSystemMailServerConfig = function () {
    // Shared variables
    const element = document.getElementById('SystemMailServerConfigSentMailManagementDetailModalId');
    const form = element.querySelector('#SystemMailServerConfigSentMailManagementDetailModalId_form');
    ...
    const initCKEditor = () => {
        ...
        elements.forEach(element => {
            ...
            DecoupledEditor
                .create(ck_editor)
                .then(editor => {
                    MPSSystemMailServerConfigSentMailManagementDetailSystemMailServerConfig_ckeditor_list[element] = editor;
    ...
    var initEditSystemMailServerConfig = () => {
        ...
        const cancelButton = element.querySelector('[systemmailserverconfigsentmailmanagement-detail-modal-action="cancel"]');
        ...
        const closeButton = element.querySelector('[systemmailserverconfigsentmailmanagement-detail-modal-action="close"]');
