...
var MPSSystemMailServerConfigSentMailManagementAddSystemMailServerConfig = function () {
    // Shared variables
    const element = document.getElementById('SystemMailServerConfigSentMailManagementCreateModalId');
    const form = element.querySelector('#SystemMailServerConfigSentMailManagementCreateModalId_form');
    ...
    var initAddSystemMailServerConfig = () => {
        ...
        var validator = FormValidation.formValidation(
            ...
            'limit_sending': {
                validators: {
                    regexp: {
                        regexp: /^[1-9]\d*$/,  // Biểu thức chính quy: số nguyên dương
                        message: 'Giới hạn gửi phải là số nguyên dương'
                    },
                }
            },
        ...
        const submitButton = element.querySelector('[systemmailserverconfigsentmailmanagement-add-modal-action="submit"]');
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        obj.tCreateNewPostFormApi('SystemMailServerConfigSentMailManagementCreateModalId_form');
...
//
        ...
        const cancelButton = element.querySelector('[systemmailserverconfigsentmailmanagement-add-modal-action="cancel"]');
        ...
        const closeButton = element.querySelector('[systemmailserverconfigsentmailmanagement-add-modal-action="close"]');
